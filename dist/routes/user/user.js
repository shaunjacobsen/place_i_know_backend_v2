...
module.exports = app => {
    ...
    app.post('/user', (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        const matches = yield models.user.findAll({
            where: {
                email: userEmail,
            },
        });
                ...
                models.user
                    ...
                    if (req.body.create_travel_request) {
                        models.travel_request
                            ...
                            .save()
                            .then((newRequest) => __awaiter(this, void 0, void 0, function* () {
                            res.status(201).json({
                                status: 'success',
                                user_id: newUser.profile_id,
                                travel_request_id: newRequest.request_id,
                                token: yield newUser.generateAuthToken(),
                                first_name: newUser.first_name,
                                avatar: 'https://res.cloudinary.com/placeiknow/image/upload/v1507692917/faces/basic.png',
                            });
                        }));
                    }
                    else {
