...
const { transformEventsForApp, transformNotesForApp, transformDirectionsForApp, } = require('./../functions/itinerary');
module.exports = (sequelize, DataTypes) => {
    ...
    Itinerary.prototype.isUserAuthorizedToView = function (user) {
        return __awaiter(this, void 0, void 0, function* () {
            if (user.role === 'admin') {
                return true;
            }
            try {
                let trip = yield sequelize.models.trip.findById(this.trip_id);
    ...
    Itinerary.prototype.getListOfEvents = function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield sequelize.models.event.findAll({
                    where: {
    ...
    Itinerary.prototype.getListOfDays = function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield sequelize.models.day.findAll({
    ...
    Itinerary.prototype.getListOfEventPlaces = function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield sequelize.models.event
                    .findAll({
                    attributes: ['place_id'],
                    where: {
                        itinerary_id: this.itinerary_id,
    ...
    Itinerary.prototype.getDateRangeOfItineraryEvents = function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield sequelize.models.day.findAll({
                    attributes: ['date'],
    ...
    Itinerary.prototype.getVerboseListOfEvents = function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const events = yield sequelize.models.day.findAll({
                    where: {
                        itinerary_id: this.itinerary_id,
                        type: 'event',
                    },
                ...
                const notes = yield sequelize.models.day.findAll({
                    where: {
                        itinerary_id: this.itinerary_id,
                        type: 'note',
                    },
                });
                const directions = yield sequelize.models.day.findAll({
                    where: {
                        itinerary_id: this.itinerary_id,
                        type: 'directions',
                    },
                ...
                const directionPlaces = yield sequelize.models.place.findAll({
    ...
    Itinerary.afterValidate((itinerary, options) => __awaiter(this, void 0, void 0, function* () {
        let errors = [];
        let associatedTrip = yield sequelize.models.trip.findById(itinerary.trip_id);
