...
const populateUsers = (users) => __awaiter(this, void 0, void 0, function* () {
    try {
...
const destroyUsers = () => __awaiter(this, void 0, void 0, function* () {
    try {
        yield models.user.destroy();
        yield models.session_key.destroy();
    }
    catch (error) { }
});
